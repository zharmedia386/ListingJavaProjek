...
public class Staff {
	...
	public Staff() {
		...
		staffList[6] = new Commission("Azhar","456 JurangStreet","555-423","33-111-444",6.25, .2);
		
		staffList[7] = new Commission("Azizan","456 JurangStreet","222-4445","459-222-33",9.75, .15);
